                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="lg:text-center">
                        ...
                        <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                            Non sed et duis dui leo, vulputate id malesuada non. Cras aliquet purus dui laoreet diam sed lacus, fames.
                        </p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div className="pt-6">
                                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                                    <div className="-mt-6">
                                        <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Los Angeles</h3>
                                        <p className="mt-2 text-base text-gray-500">
                                            4556 Brendon Ferry<br />
                            ...
                            <div className="pt-6">
                                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                                    <div className="-mt-6">
                                        <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">New York</h3>
                                        <p className="mt-2 text-base text-gray-500">
                            ...
                            <div className="pt-6">
                                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                                    <div className="-mt-6">
                                        <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Toronto</h3>
                                        <p className="mt-2 text-base text-gray-500">
                            ...
                            <div className="pt-6">
                                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                                    <div className="-mt-6">
                                        <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">London</h3>
                                        <p className="mt-2 text-base text-gray-500">
                                            114 Cobble Lane<br />
                                            London N1 2EF
                                        </p>
